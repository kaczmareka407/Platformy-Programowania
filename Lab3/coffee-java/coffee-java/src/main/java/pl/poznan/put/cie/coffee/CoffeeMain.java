		...
		while (true) {
			...
			switch (in.nextLine()) {
				...
				case "c": {
					System.out.println("Please enter coffee name : ");
					String name = in.nextLine();
					System.out.println("Please enter coffee supplier ID : ");
					...
					System.out.println("Please enter coffee sales : ");
					int sales = Integer.parseInt(in.nextLine());
					System.out.println("Please enter coffee total : ");
				...
				case "e": {
					System.out.println("Please enter coffee name : ");
					String name = in.nextLine();
					System.out.println("Please enter coffee suppplier ID : ");
					int supId = Integer.parseInt(in.nextLine());
